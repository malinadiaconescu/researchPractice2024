...
DeepLabV1_model = DeepLabV1(((input_image_size[0], input_image_size[1], 3)))
DeepLabV1_model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
DeepLabV1_model.summary()
...
# Evaluate the model
test_loss, test_accuracy = DeepLabV1_model.evaluate(images_test, masks_test, verbose=0)

# Prediction
y_pred = DeepLabV1_model.predict(images_test)
...
filename = "DeepLabV1 25 Epochs.txt"
